...
{
    Task<List<Sprint>> GetByProjectAsync(int projectId, Guid companyId, bool includeArchived, CancellationToken ct);
    ...
    Task<Sprint?> GetByCompanyAsync(Guid companyId, int sprintId, CancellationToken ct);
}